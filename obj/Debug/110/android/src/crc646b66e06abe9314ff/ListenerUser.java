...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Tests_Program.ListenerUser, Tests Program", ListenerUser.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == ListenerUser.class)
			mono.android.TypeManager.Activate ("Tests_Program.ListenerUser, Tests Program", "", this, new java.lang.Object[] {  });
	}
